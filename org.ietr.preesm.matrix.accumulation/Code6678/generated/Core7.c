...
extern char *const generateMatrices__explode_ge__0;  // generateMatrices > explode_generateMatrices_startArray size:= 256*char defined in Core0
...
extern long *const startArray__inputArray__0;  // generateMatrices_startArray > explode_generateMatrices_startArray_inputArray size:= 64*long defined in Core0
...
extern char *const explode_generateMatrices_sta__6;  // explode_generateMatrices_startArray > accumulateMatrices_5 size:= 32*char defined in Core0
...
extern char *const FIFO_Head_broadcastOutput_en__0;  // FIFO_Head_broadcastOutput_end_output1_56 > accumulateMatrices_7_init_runningTotal size:= 32*char defined in Core3
extern char *const FIFO_Head_broadcastOutput_en__6;  // FIFO_Head_broadcastOutput_end_output1_8 > accumulateMatrices_1_init_runningTotal size:= 32*char defined in Core4

// Core Global Definitions
char *const FIFO_Head_generateMatrices_e__0 = (char*) (SharedMem+1792);  // FIFO_Head_generateMatrices_end_countOut > generateMatrices_init_countIn size:= 4*char
